<template>
  ...
  >
    <div class="w-[40vw] h-[40vw] max-w-[380px] max-h-[380px] bg-titleBrown overflow-hidden">
      <div
        id="loader-block"
        class="w-full h-full bg-[white] flex justify-center items-center relative left-[-50vw]"
      >
        <UIText id="loader-text" class="text-black text-[calc(1vw+1vh*15)]">22</UIText>
      </div>
    </div>
  </div>
</template>
...
onMounted((): void => {
  ...
  tl.fromTo('#loader-text', { opacity: 0 }, { opacity: 1, duration: 2 });
