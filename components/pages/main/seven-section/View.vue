  ...
  <div class="w-full h-full flex justify-around">
    ...
    >
      <div id="section7textcontainer" class="md:w-[25%] md:h-[300px] mx-5">
        <UIText tag="h1" class="font-trajan text-black md:text-[calc(1vw+1vh*2.1)] text-[1.5rem]">
          Окружение
        </UIText>
        <UIText
          tag="p"
          class="font-helvetica text-black md:text-[calc(1vw+1vh*0.7)] md:text-[1.1rem]"
        >
