  ...
  <div id="section2navigation" class="flex gap-5 md:justify-start justify-between">
    <div class="flex flex-col">
      <div class="flex mb-3 items-center gap-5">
        <UIText
          tag="p"
          class="font-helvetica lg:text-[calc(1vh+1vw*1.2)] md:text-[calc(1vh+1vw*1.5)] text-black cursor-pointer"
        >
          Корпус
        </UIText>
        ...
        <div class="flex gap-5">
          ...
          >
            <UIText
              tag="p"
              class="font-helvetica lg:text-[calc(1vh+1vw*1.1)] md:text-[calc(1vh+1vw*1.3)] text-black"
            >
              2
            </UIText>
          </NuxtLink>
